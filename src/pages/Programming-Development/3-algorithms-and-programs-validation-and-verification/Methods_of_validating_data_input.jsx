...
function Methods_of_validating_data_input() {
  return (
                          ...
                          >
                            ...
                            <div itemprop="articleBody">
                              ...
                              <p>
                                ...
                                Validation is the term used to describe the
                                automatic checking of data as it is entered into
                                any computer system, often a database or
                                spreadsheet. The aim is to allow only sensible
                                data to be entered. Sensible data means that it
                                follows any validation rules set up for that
                                field. Verification is checking that the
                                sensible data you entered (which passed the
                                validation rules set up for that data) is
                                actually the data you meant to enter.
                              </p>

                              <p>
                                For example, if you had to enter the number of
                                siblings into a program (the number of brothers
                                and sisters you had), and the validation rule
                                was 'Greater than or equal to zero and less than
                                10' you might enter 3. 3 is valid data because
                                it obeys the validation rule for siblings. The
                                problem is, you meant to enter 2, because you
                                have two siblings not 3. You can only pick this
                                problem up by a suitable verification technique.
                              </p>
                              <table
                                style="
                              margin-left: 76.3pt;
                            ...
                            "
                                  ...
                                  "
                                    ...
                                    >
                                      ...
                                      >
                                        ...
                                        "
                                          >
                                            Enter data twice and computer checks
                              ...
                              <p>
                                We will look at a range of validation methods
                                first and then some verification methods.
                              </p>
                              <p>
                                ...
                                numbers and so on. If a value is entered outside
                                of this range, then a helpful error message
                              ...
                              <ul>
                                <li style="list-style-type: none">
                                  <ul style="list-style-type: disc">
                                    <li>
                                      Number of attempts &lt; 3 (Number of
                                      attempts must be less than three).
                                    </li>
                                    <li>
                                      Number of items &lt;= 5 (Number of items
                                      must be less than or equal to five).
                                    </li>
                                    <li>
                                      Minimum bet &gt; 100 (The minimum bet must
                                      be great than one hundred).
                                    </li>
                                    <li>
                                      Minimum bet &gt;= 100 (The minimum bet
                                      must be greater than or equal to one
                                      hundred).
                                    </li>
                                    <li>
                                      Score &gt;= 0 AND &lt;=180 (The score must
                                      be between 0 and 180 inclusive).
                                    </li>
                                    <li>
                                      Score BETWEEN 0 AND 180 (A different way
                                      of writing a rule that the score must be
                              ...
                              <p>
                                ...
                                mixture of numbers and letters in a certain
                                order. For example, a national chess club may
                                have a membership ID that is made up of 2
                                letters, followed by 3 numbers, followed by a
                                letter, for example, RG662P. You can set up
                                rules that look for patterns such as
                                <br />
                              ...
                              <p>
                                ...
                                validation rule. It has more than 10 characters.
                              </p>
                              <p>
                              ...
                              <p>
                                ...
                                read and a maths formula applied to it. If the
                                result is the same as the check digit, then the
                                code has been read correctly. There are
                                different methods of working this out. One
                                method is called 'modulus 11' and is used in
                                ISBN numbers. Study this example
                              </p>
                              <p>
                                Suppose you have the number 12162? The question
                                mark at the end is the check digit but what
                                should it be? The check digit will be
                                calculated, in this case, using 'modulus 11'.
                              </p>
                              <table
                                  ...
                                  "
                                    ...
                                    "
                                      ...
                                      >
                                        ...
                                        "
                                          >
                                            A number, starting at 2 on the right
                                            and then increase by 1 as you move
                                            towards the left.
                                          </span>
                                        </strong>
                                      </p>
                                  ...
                                  "
                                    ...
                                    >
                                      ...
                                      >
                                        ...
                                        "
                                          >
                                            Multiply the vertical pairs of
                                            numbers, and add the results. In
                                            this example, we get 42.
                                          </span>
                                        </strong>
                                      </p>
                                    </td>
                              ...
                              <p>
                                42 is then divided by 11 (because we are using
                                modulus 11. You could use modulus 6, or 7, for
                                example). This equals 3 remainder 9. The
                                remainder is now subtracted from 11 to give the
                                check digit. 11 - 9 = 2.
                              </p>
                              <p>2 is the check digit!</p>
                              <p>There are 2 special cases to remember.</p>
                              <ol>
                                <li style="list-style-type: none">
                                  <ol>
                                    <li>
                                      If the remainder is 0, then the check
                                      digit is 0.
                                    </li>
                                    <li>
                                      If the remainder is 1, then the check
                                      digit is X.
                                    </li>
                                  </ol>
                                </li>
                              ...
                              <p>
                                <strong>What about 13 digit ISBN codes?</strong>
                                <br />
                                The code for a book under the barcode is
                                978-0-954351472. The check digit is the number
                                on the right hand side, 2. A barcode scanner
                                would read the first 12 digits of the ISBN code
                                and then see if it got a 2. If it did get a 2,
                                it would know that the ISBN code had probably
                                been scanned correctly. How does it work out the
                                check digit?
                              </p>
                              <ul style="list-style-type: disc">
                                <li style="list-style-type: none">
                                  <ul style="list-style-type: disc">
                                    <li>
                                      First, it multiplies each digit in turn by
                                      a 1, then a 3, then a 1, then a 3 and so
                                      on, and adds up the result, like this:
                                    </li>
                                    <li>
                                      (9 x 1) + (7 x 3) + (8 x 1) + (0 x 3) + (9
                                      x 1) + (5 x 3) + (4 x 1) + (3 x 3) + (5 x
                                      1) + (1 x 3) + (4 x 1) + (7 x 3) = 138
                                    </li>
                                    <li>
                                    ...
                                    <li>
                                      Finally, it subtracts the reminder from
                                      10, so 10 – 8 = 2. (This system uses
                                      something called ‘modulo 10’, which just
                                      means the remainder after you divide a
                                      number by 10).
                                    </li>
                                    <li>
                                      As you can see, the check digit is 2,
                                      which is also the number on the right hand
                                      side of the 13 digit ISBN code.
                                    </li>
                                  </ul>
                                </li>
                              </ul>
                              <p>
                                Do note that 10 digit ISBN numbers use a
                                different system to the one described here for
                              ...
                              <p>
                                ...
                                appear. This kind of validation rule is known as
                                a 'presence check'.
                              </p>
                              <p>
...
export default Methods_of_validating_data_input;
