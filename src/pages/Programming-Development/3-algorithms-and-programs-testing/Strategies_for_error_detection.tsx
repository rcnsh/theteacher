...
function Strategies_for_error_detection() {
  return (
                        ...
                        <div id="jsn-mainbody">
                          ...
                          >
                            ...
                            <div itemprop="articleBody">
                              ...
                              <p>
                                <img
                                  src="images/b17a169c-e372-4c09-bc01-caded9422ffba.gif"
                                  alt
                                />
                              </p>
                              <p>
                              ...
                              <p class="NormalContent">
                                <strong>
                                  <span class="NormalContentHeading">
                                    <img
                                      src="images/ef1030ad-bc14-4d06-beb4-28c008a0dfacb.gif"
                                      alt
                                    />
                                  </span>
                                </strong>
                              ...
                              <p>
                                <img
                                  src="images/7d40d7e8-b5df-4318-9007-a07354e52126blackbox.JPG"
                                  alt
                                />
                              </p>
                              <p>
...
export default Strategies_for_error_detection;
