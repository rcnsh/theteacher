...
function Improving_the_design_of_a_flat_file() {
  return (
                            ...
                            <div itemprop="articleBody">
                              ...
                              <p>
                                <strong>
                                  ...
                                  margin-right: auto;
                                "
                                    src="images/93c2a545-2944-4fd1-9b30-df6b9ac51d30er1.JPG"
                                    alt="er1"
                                  />
                                </strong>
                              </p>
                              ...
                              <p style="text-align: center">
                                <img
                                  src="images/50811012-b6ef-4408-a5de-2cbaf1bc3125table2.JPG"
                                  alt="table2"
                                />
                              </p>
                              <p>
...
export default Improving_the_design_of_a_flat_file;
